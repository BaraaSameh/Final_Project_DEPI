...
{
    /// <inheritdoc />
    public partial class Addwishlistandsales : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlashSaleProducts", x => x.FlashSaleProductID);
                    table.ForeignKey(
